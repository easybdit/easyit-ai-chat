...
class EAIC_Order_Bot {
	...
	public static function shortcode() {
		...
		ob_start();
		?>
		<div class="eaic-order-bot" id="eaic-order-bot">
			<div class="eaic-ob-header">
				<div class="eaic-ob-header-icon">📦</div>
				<div>
					<div class="eaic-ob-header-title"><?php esc_html_e( 'Order Status', 'easyit-ai-chat' ); ?></div>
					<div class="eaic-ob-header-sub"><?php esc_html_e( 'Powered by AI', 'easyit-ai-chat' ); ?></div>
				</div>
			</div>
			<div class="eaic-ob-verify" id="eaic-order-bot-verify">
				<input type="number" id="eaic-order-id" min="1"
					placeholder="<?php esc_attr_e( 'Order #', 'easyit-ai-chat' ); ?>" />
				<input type="email" id="eaic-order-email"
					placeholder="<?php esc_attr_e( 'Email on the order', 'easyit-ai-chat' ); ?>" />
			</div>
			<div class="eaic-ob-log" id="eaic-order-bot-log" aria-live="polite"></div>
			<div class="eaic-ob-input-area">
				<div class="eaic-ob-input-wrap">
					<input type="text" id="eaic-order-msg" autocomplete="off"
						placeholder="<?php esc_attr_e( 'Ask about your order…', 'easyit-ai-chat' ); ?>" />
					<button type="button" id="eaic-order-send" class="eaic-ob-send-btn" aria-label="<?php esc_attr_e( 'Send', 'easyit-ai-chat' ); ?>">
